export const CarouselDots = () => {
  return (
    <div className="absolute items-center box-border caret-transparent flex flex-wrap justify-center translate-x-[-50.0%] w-[90%] mt-8 left-2/4">
      <button
      ...
      >
        <span className="bg-white box-border caret-transparent block h-full w-full"></span>
      </button>
      <button
      ...
      >
        <span className="bg-white box-border caret-transparent block h-full opacity-35 w-full"></span>
      </button>
      <button
